...
def set_all_paths(config, wb_run_name=None):
    ...
    if config['hpc']:
        pred_dens_path_val = config['hpc_base_path'] + f"split_{config['data_split']}/" + pred_dens_path_val
        pred_dens_path_test = config['hpc_base_path'] + f"split_{config['data_split']}/" + pred_dens_path_test
        density_delta_path_val = config['hpc_base_path'] + f"split_{config['data_split']}/" + density_delta_path_val
        density_delta_path_test = config['hpc_base_path'] + f"split_{config['data_split']}/" + density_delta_path_test
        gaus_pos_path_val = config['hpc_base_path'] + f"split_{config['data_split']}/" + config['gaus_pos_path_val']
        gaus_pos_path_test = config['hpc_base_path'] + f"split_{config['data_split']}/" + config['gaus_pos_path_test']
        gaus_pos_outlier_path = config['hpc_base_path'] + f"split_{config['data_split']}/" + config['gaus_pos_outlier_path']
    if config['wandb']:
...
def get_files(config):
    ...
    if file_split != "ECD" and file_split != "ECD_test" and file_split != "nmc" and file_split != "mp_mixed" and file_split != "mpfull2025":
